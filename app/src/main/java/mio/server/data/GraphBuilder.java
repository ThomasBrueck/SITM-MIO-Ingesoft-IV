...
public class GraphBuilder {
    ...
    // Getters
    public Map<Integer, Stop> getStopsMap() { return stopsMap; }
    public Map<Integer, Line> getLinesMap() { return linesMap; }
    public List<Arc> getAllArcs() { return allArcs; }
    public Map<String, List<Arc>> getArcsByLineAndOrientation() { return arcsByLineAndOrientation; }
     ...
     * 
     * @param originStopId ID de la parada de origen
     * @return Set con los IDs de todas las paradas alcanzables (incluyendo la propia parada de origen)
     */
